<template>
        <div>
            <div class="container-fluid hero-section d-flex align-content-center justify-content-center flex-wrap ml-auto">
                <h2 class="title">Welcome to Doxavic Store</h2>
            </div>
            <div class="container">
                <div class="row">
                <div class="col-md-offset-8 col-md-2"></div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                         ...
                         :shirtimagepath="product">
                               ...
                               <!-- <router-link :to="{ path: '/products/'+product.id}">
                                    ...
                                    <button class="col-md-4 btn btn-sm btn-primary float-right">Add to cart</button>
